import { BOOKING_URL, CTA_LABEL, FIRST_LINK_DAYS, WHATSAPP_URL } from '../content/site'
  ...
  <footer className="ed-footer">
    <div className="ed-foot-top">
      <div>
        ...
        <p className="ed-foot-tag">Fixed price. Date in writing. A working link in {FIRST_LINK_DAYS} days.</p>
      </div>
    ...
    <div className="ed-foot-bottom">
      ...
      <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">{CTA_LABEL} ↗</a>
    </div>
