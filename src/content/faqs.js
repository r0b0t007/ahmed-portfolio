...
export const faqs = [
  ...
  {
    q: 'How fast is "fast"?',
    a: 'A marketing site is usually 2 to 3 weeks. An MVP is usually 4 to 6, depending on what goes in it. You get a date in the written scope before you commit, and a working link in the first week. Building with AI is what makes those numbers realistic.',
  },
  {
  ...
  },
  {
    ...
    a: `Not for this offer yet. Nine years of my work sits inside enterprise programmes under NDA, and the independent client side is new. What you can look at instead is the products I build and run myself: ${productClause}; plus this site, with its source published. It’s also why the first few projects go out at reduced rates: I’m trading price for proof.`,
  },
  {
    q: 'What does it cost?',
    a: 'Fixed price per project, quoted in the free scope call and based on what the project needs rather than hours logged. No retainers you can’t exit, and no invoices you didn’t see coming. Reduced founding-client rates apply to the next few projects.',
  },
  {
    q: 'Who owns the code?',
    a: 'You do, outright and from day one. Your repo, your infrastructure, your accounts. The handover includes documentation and a walkthrough so you can take the project to another developer whenever you want.',
  },
  {
